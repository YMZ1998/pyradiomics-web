...
Cross_score={}
#分类
NAME=['svm','forest','knn','bayes','MLP','adaboost','decisiontree','logistic','SGD','xgboost','bagging','GB']
for modelname in NAME[-1:]:
    ...
    if modelname=='forest':
        ...
        from sklearn.neighbors import KNeighborsClassifier
        from sklearn.linear_model import LogisticRegression
        model= BaggingClassifier(LogisticRegression(solver='liblinear',penalty='l2',max_iter=50,C=0.4),n_estimators=10,
